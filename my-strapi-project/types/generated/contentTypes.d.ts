...
export interface ApiGameGame extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    gameAchievements: Schema.Attribute.String;
    gameDesc: Schema.Attribute.Text;
    gameHoursPlayed: Schema.Attribute.Decimal;
    gameImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    gameName: Schema.Attribute.String;
    gameSteamLink: Schema.Attribute.String;
    isFavoriteGame: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiGenreGenre extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    genreSteamLink: Schema.Attribute.String;
